  ...
  return (
    <>
      ...
      <Drawer
        ...
        PaperProps={{
          sx: { width: 450, height: "100%", display: "flex", flexDirection: "column" },
        }}
      >
        {/* Header */}
        <Box
              ...
              >
                ...
                <Paper
                  ...
                  sx={{
                    px: 2,
                    py: 1,
                    bgcolor: msg.sender === "user" ? "#e4f6ffff" : "#fdfdfdff",
                    maxWidth: "75%",
                    borderRadius: 1,
                  }}
                >
        ...
        {/* Input Area */}
        <Box p={2} borderTop={1} display="flex" gap={1}>
          <TextField
            variant="outlined"
            size="small"
            fullWidth
          ...
          <Button
            ...
            sx={{ minWidth: "64px" }}
          >
            {loading ? <CircularProgress size={20} color="inherit" /> : "Gửi"}
          </Button>
        </Box>
      </Drawer>
    </>
